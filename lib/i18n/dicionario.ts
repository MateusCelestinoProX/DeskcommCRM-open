...
"Entra sozinho: os produtos vêm da sincronização com a sua loja, não de conteúdo digitado aqui.": { es: "Entra solo: los productos vienen de la sincronización con tu tienda, no de contenido escrito aquí." },
  ...
  // ─── Custom Chat Resources: Disparador, Agendador, Mídia, Monitor & Validador ───
  "Campanha / Sequência": { es: "Campaña / Secuencia" },
  "Destinatários (Para quem)": { es: "Destinatarios (Para quién)" },
  "Operador (Por quem)": { es: "Operador (Por quién)" },
  "Contém Mídia": { es: "Contiene multimedia" },
  "Detalhes do Agendamento": { es: "Detalles de la programación" },
  "Título da Campanha:": { es: "Título de la campaña:" },
  "Data & Hora de Disparo:": { es: "Fecha y hora de envío:" },
  "Responsável / Operador:": { es: "Responsable / Operador:" },
  "Destinatários": { es: "Destinatarios" },
  "Padrão com chaves de nomes e DDD +55 com sanitização automática.": { es: "Patrón con llaves de nombres y prefijo +55 con saneamiento automático." },
  "Sequência de Mensagens": { es: "Secuencia de mensajes" },
  "Configure os textos com Spintax, anexos de áudio/mídia e intervalos entre cada envio.": { es: "Configure los textos con Spintax, archivos de audio/multimedia e intervalos entre envíos." },
  "Adicionar Etapa": { es: "Agregar paso" },
  "Etapa #": { es: "Paso #" },
  "Remover Etapa": { es: "Eliminar paso" },
  "Mensagem da etapa com Spintax {Olá|Oi} {primeiro_nome}...": { es: "Mensaje del paso con Spintax {Hola|Qué tal} {primer_nombre}..." },
  "Mídia vinculada:": { es: "Multimedia vinculada:" },
  "Remover mídia": { es: "Eliminar multimedia" },
  "Aguardar antes da próxima etapa:": { es: "Esperar antes del siguiente paso:" },
  "segundos": { es: "segundos" },
  "Voltar ao Painel": { es: "Volver al panel" },
  "Validar Contatos e Salvar Agendamento": { es: "Validar contactos y guardar programación" },
  "Painel de Agendamentos": { es: "Panel de programaciones" },
  "Novo Agendamento ou Sequência": { es: "Nueva programación o secuencia" },
  "Painel de Disparos Programados": { es: "Panel de envíos programados" },
  "Acompanhe o que foi agendado, para quando, para quem e por qual operador.": { es: "Acompañe lo programado, para cuándo, para quién y por qué operador." },
  "Pendente(s)": { es: "Pendiente(s)" },
  "Carregando agendamentos...": { es: "Cargando programaciones..." },
  "Nenhum agendamento ativo.": { es: "Ninguna programación activa." },
  ...
  "Carregando agendamentos...": { es: "Cargando programaciones..." },
  "Nenhum agendamento ativo.": { es: "Ninguna programación activa." },
  "Clique em \"Novo Agendamento ou Sequência\" para programar um envio.": { es: "Haga clic en \"Nueva programación o secuencia\" para programar un envío." },
  "Data & Hora Agendada": { es: "Fecha y hora programada" },
  "Aguardando disparador": { es: "Esperando disparador" },
  "contato(s)": { es: "contacto(s)" },
  "etapas": { es: "pasos" },
  "mensagem": { es: "mensaje" },
  "Disparar": { es: "Disparar" },
  "Deseja realmente excluir este agendamento?": { es: "¿Desea realmente eliminar esta programación?" },
  "Falha ao salvar agendamento.": { es: "Fallo al guardar la programación." },
  "Erro ao agendar.": { es: "Error al programar." },
  "Por favor, insira pelo menos um número com DDD válido.": { es: "Por favor, introduzca al menos un número con prefijo válido." },
  "Simulando digitação humana...": { es: "Simulando escritura humana..." },
  "Erro no envio pelo WAHA": { es: "Error en el envío por WAHA" },
  "⚠️ ALERTA DE SEGURANÇA WAHA (Error 463 - Reachout Timelock):\nO WhatsApp pausou temporariamente o envio a novos contatos neste chip. O disparo foi pausado para evitar banimento.": { es: "⚠️ ALERTA DE SEGURIDAD WAHA (Error 463 - Reachout Timelock):\nWhatsApp pausó temporalmente el envío a nuevos contactos en este chip. El envío fue pausado para evitar bloqueos." },
  "Entregue via WAHA": { es: "Entregado vía WAHA" },
  "Falha de rede": { es: "Fallo de red" },
  "Motor Anti-Ban Ativo": { es: "Motor Anti-Ban Activo" },
  "Longevidade Máxima": { es: "Longevidad máxima" },
  "Spintax recursivo, simulação de digitação humana e validação prévia contra rejeições.": { es: "Spintax recursivo, simulación de escritura humana y validación previa contra rechazos." },
  "Sessão:": { es: "Sesión:" },
  "Destinatários com Chaves": { es: "Destinatarios con llaves" },
  "Insira linha por linha no formato de chaves com +55.": { es: "Introduzca línea por línea en el formato de llaves con +55." },
  "detectado(s)": { es: "detectado(s)" },
  "Padrão reconhecido:": { es: "Patrón reconocido:" },
  "Exemplo:": { es: "Ejemplo:" },
  "Carlos/Eduardo/Carlos Eduardo, Cliente VIP +5531999999999": { es: "Carlos/Eduardo/Carlos Eduardo, Cliente VIP +5531999999999" },
  "DDD e prefixo +55 sanitizados automaticamente.": { es: "Prefijo y código de área saneados automáticamente." },
  "Limpar Lista": { es: "Limpiar lista" },
  "Espaçamento & Pacing": { es: "Espaciado y ritmo" },
  "Anti-Bloqueio": { es: "Anti-Bloqueo" },
  "Alternante (Aleatório)": { es: "Alternante (Aleatorio)" },
  "Jitter imprevisível entre X e Y s": { es: "Jitter impredecible entre X e Y s" },
  "Espaço Direto (Fixo)": { es: "Espacio directo (Fijo)" },
  "Intervalo regular constante": { es: "Intervalo regular constante" },
  "Mínimo (segundos):": { es: "Mínimo (segundos):" },
  "Máximo (segundos):": { es: "Máximo (segundos):" },
  "A cada:": { es: "Cada:" },
  "Unidade:": { es: "Unidad:" },
  "Segundos": { es: "Segundos" },
  "Minutos": { es: "Minutos" },
  "Simular Digitação Humana (WAHA Presence)": { es: "Simular escritura humana (WAHA Presence)" },
  "Emite status \"digitando...\" proporcional ao tamanho da mensagem antes de enviar.": { es: "Emite estado \"escribiendo...\" proporcional al tamaño del mensaje antes de enviar." },
  "Mensagem Dinâmica com Spintax": { es: "Mensaje dinámico con Spintax" },
  "Use chaves": { es: "Use llaves" },
  "para criar mensagens aleatórias e únicas por destinatário.": { es: "para crear mensajes aleatorios y únicos por destinatario." },
  "Testar Variação": { es: "Probar variación" },
  "Inserir tag:": { es: "Insertar etiqueta:" },
  "Primeiro nome": { es: "Primer nombre" },
  "Sobrenome": { es: "Apellido" },
  "Tag/texto custom": { es: "Etiqueta/texto personalizado" },
  "Bom dia/tarde/noite": { es: "Buenos días/tardes/noches" },
  "Ex: {Olá|Oi} {primeiro_nome}, {como vai?|tudo bem com você?}...": { es: "Ej: {Hola|Qué tal} {primer_nombre}, {cómo estás?|todo bien contigo?}..." },
  "Amostras Aleatórias de Variação (Spintax):": { es: "Muestras aleatorias de variación (Spintax):" },
  "Variação #": { es: "Variación #" },
  "Anexo de Mídia (WAHA Engine)": { es: "Archivo adjunto (WAHA Engine)" },
  "Anexar Mídia": { es: "Adjuntar multimedia" },
  "Áudio (PTT Voz)": { es: "Audio (Voz PTT)" },
  "URL Direta da Mídia (HTTPS):": { es: "URL directa del archivo (HTTPS):" },
  "https://meuservidor.com/arquivo.jpg ou .mp3": { es: "https://miservidor.com/archivo.jpg o .mp3" },
  "Legenda Opcional da Mídia:": { es: "Pie de foto/texto opcional:" },
  "Legenda anexada junto ao arquivo...": { es: "Texto adjunto junto al archivo..." },
  "* Mídias de áudio são convertidas automaticamente pela API WAHA para formato nativo de nota de voz (PTT gravado com microfone).": { es: "* Los audios son convertidos automáticamente por la API WAHA a formato nativo de nota de voz (PTT grabado con micrófono)." },
  "Validar Números e Iniciar Disparo": { es: "Validar números e iniciar envío masivo" },
  "Disparo em Andamento": { es: "Envío masivo en curso" },
  "Progresso:": { es: "Progreso:" },
  "Espaçamento de segurança (Jitter anti-ban):": { es: "Espaciado de seguridad (Jitter anti-ban):" },
  "Próximo envio em": { es: "Siguiente envío en" },
  "Histórico da rodada:": { es: "Historial de la ronda:" },
  "Validador Automático de WhatsApp": { es: "Validador automático de WhatsApp" },
  "Zero Bounces Anti-Ban": { es: "Zero Bounces Anti-Ban" },
  "Verificação de existência de conta no WhatsApp via WAHA antes do início do disparo.": { es: "Verificación de existencia de cuenta en WhatsApp vía WAHA antes de iniciar el envío." },
  "Consultando existência no WhatsApp...": { es: "Consultando existencia en WhatsApp..." },
  "número(s) com cadência segura de conexão.": { es: "número(s) con cadencia segura de conexión." },
  "Tentar Novamente": { es: "Intentar nuevamente" },
  "Válidos": { es: "Válidos" },
  "WhatsApp Ativo": { es: "WhatsApp activo" },
  "Sem WhatsApp": { es: "Sin WhatsApp" },
  "Inexistentes no WA": { es: "Inexistentes en WA" },
  "Inválidos": { es: "Inválidos" },
  "Formato / DDD": { es: "Formato / Prefijo" },
  "Destinatário": { es: "Destinatario" },
  "Status WAHA": { es: "Estado WAHA" },
  "Válido": { es: "Válido" },
  "Voltar e Ajustar": { es: "Volver y ajustar" },
  "Disparar Apenas para os Válidos": { es: "Disparar solo a los válidos" },
  "Agendado": { es: "Programado" },
  "Em Execução": { es: "En ejecución" },
  "Carlos/Eduardo/Carlos Eduardo, VIP +553175023319": { es: "Carlos/Eduardo/Carlos Eduardo, VIP +553175023319" },
  "Custom chat resourses": { es: "Recursos de chat personalizados" },
  "Disparador": { es: "Disparador" },
  "Agendador": { es: "Agendador" },

  // Abas Mídia e Monitor
  "Mídia": { es: "Multimedia" },
  "Monitor": { es: "Monitor" },

  // Mídia & Gravador PTT
  "Central de Mídias e Conteúdos": { es: "Centro de multimedia y contenidos" },
  "Áudios Gravados na Hora (PTT)": { es: "Audios grabados al instante (PTT)" },
  "Faça upload direto de imagens, vídeos, documentos e áudios de voz para usar em disparos e sequências.": { es: "Suba directamente imágenes, videos, documentos y audios de voz para usar en envíos y secuencias." },
  "Total armazenado:": { es: "Total almacenado:" },
  "Upload Direto de Mídias": { es: "Subida directa de archivos" },
  "Selecione arquivos de imagem (PNG, JPG), áudio (MP3, OGG, WAV), vídeos ou PDFs do seu computador.": { es: "Seleccione archivos de imagen (PNG, JPG), audio (MP3, OGG, WAV), videos o PDFs de su computadora." },
  "Processando upload...": { es: "Procesando subida..." },
  "Clique ou arraste um arquivo para cá": { es: "Haga clic o arrastre un archivo aquí" },
  "PNG, JPG, MP4, MP3, OGG, PDF (Até 50MB)": { es: "PNG, JPG, MP4, MP3, OGG, PDF (Hasta 50MB)" },
  "Mídia enviada com sucesso para a biblioteca!": { es: "¡Multimedia subida con éxito a la biblioteca!" },
  "Falha no upload": { es: "Fallo en la subida" },
  "Gravar Áudio na Hora (PTT)": { es: "Grabar audio al instante (PTT)" },
  "Microfone Verde": { es: "Micrófono verde" },
  "Grave sua voz pelo microfone. No WhatsApp do cliente, será entregue como se você estivesse gravando naquele exato instante.": { es: "Grabe su voz con el micrófono. En el WhatsApp del cliente se entregará como si estuviera grabando en ese instante." },
  "Gravando...": { es: "Grabando..." },
  "Concluir e Salvar na Central": { es: "Finalizar y guardar en el centro" },
  "Iniciar Gravação com Microfone": { es: "Iniciar grabación con micrófono" },
  "Áudio gravado na hora salvo com sucesso!": { es: "¡Audio grabado al instante guardado con éxito!" },
  "Permissão para acessar microfone foi negada ou não está disponível.": { es: "Permiso para acceder al micrófono denegado o no disponible." },
  "Mídias Disponíveis no Sistema": { es: "Archivos disponibles en el sistema" },
  "Imagens": { es: "Imágenes" },
  "Áudios PTT": { es: "Audios PTT" },
  "Vídeos": { es: "Videos" },
  "Documentos": { es: "Documentos" },
  "Nenhuma mídia encontrada nesta categoria.": { es: "Ningún archivo encontrado en esta categoría." },
  "Excluir Mídia": { es: "Eliminar archivo" },
  "Gravado na hora • PTT WhatsApp": { es: "Grabado al instante • PTT WhatsApp" },
  "PTT Ativo": { es: "PTT Activo" },
  "No Disparador": { es: "En Disparador" },
  "No Agendador": { es: "En Agendador" },
  "Deseja realmente remover esta mídia da biblioteca?": { es: "¿Desea realmente eliminar este archivo de la biblioteca?" },
  "Erro ao excluir mídia": { es: "Error al eliminar archivo" },

  // WhatsApp Chat Preview
  "Simulação Exata WhatsApp": { es: "Simulación exacta WhatsApp" },
  "O que você vê aqui é o que o cliente receberá:": { es: "Lo que ve aquí es lo que el cliente recibirá:" },
  "Regerar variação de Spintax": { es: "Regenerar variación de Spintax" },
  "Regerar": { es: "Regenerar" },
  "via": { es: "vía" },
  "Nota de voz gravada na hora (PTT)": { es: "Nota de voz grabada al instante (PTT)" },

  // Monitor Dashboard
  "Monitor de Disparos em Tempo Real": { es: "Monitor de envíos en tiempo real" },
  "Finalizado": { es: "Finalizado" },
  "Pronto / Aguardando": { es: "Listo / Esperando" },
  "Acompanhamento minucioso de cada número, status visual e controle manual com 'Enviar Agora'.": { es: "Seguimiento minucioso de cada número, estado visual y control manual con 'Enviar ahora'." },
  "Retomar Disparo": { es: "Reanudar envío" },
  "Pausar Disparo": { es: "Pausar envío" },
  "Cancelar Fila": { es: "Cancelar cola" },
  "Iniciar Disparo da Fila": { es: "Iniciar envío de la cola" },
  "Total de Números": { es: "Total de números" },
  "Enviados com Sucesso": { es: "Enviados con éxito" },
  "Falta Disparar (Fila)": { es: "Falta enviar (Cola)" },
  "Erros / Rejeições": { es: "Errores / Rechazos" },
  "Progresso Geral:": { es: "Progreso general:" },
  "concluídos": { es: "completados" },
  "Intervalo de segurança ativo (Anti-bloqueio):": { es: "Intervalo de seguridad activo (Anti-bloqueo):" },
  "Próximo disparo em": { es: "Siguiente envío en" },
  "Fila de Destinatários e Status Individual": { es: "Cola de destinatarios y estado individual" },
  "contatos na rodada": { es: "contactos en la ronda" },
  "Nenhum disparo iniciado no momento.": { es: "Ningún envío iniciado en este momento." },
  "Vá até o Disparador, insira seus números e clique em 'Começar Disparo'.": { es: "Vaya al Disparador, introduzca sus números y haga clic en 'Iniciar envío'." },
  "Enviado": { es: "Enviado" },
  "Enviar Agora": { es: "Enviar ahora" },
  "Quebrar a lógica de espera e enviar imediatamente para este contato": { es: "Romper la lógica de espera y enviar inmediatamente a este contacto" },
  "Enviado agora manualmente": { es: "Enviado ahora manualmente" },
  "Erro no envio imediato": { es: "Error en el envío inmediato" },

  // Slot de Teste & Anexos
  "Slot de Envio de Teste": { es: "Ranura de envío de prueba" },
  "Padrão: 31998622489": { es: "Predeterminado: 31998622489" },
  "Escolha um número em branco para disparar uma mensagem de teste antes do lote.": { es: "Elija un número en blanco para enviar un mensaje de prueba antes del lote." },
  "Número de Telefone (com DDD):": { es: "Número de teléfono (con código):" },
  "Nome para Simulação:": { es: "Nombre para simulación:" },
  "Enviar Teste Agora": { es: "Enviar prueba ahora" },
  "Mensagem de teste entregue via WAHA com sucesso!": { es: "¡Mensaje de prueba entregado vía WAHA con éxito!" },
  "Falha no envio de teste": { es: "Fallo en el envío de prueba" },
  "Falha de conexão": { es: "Fallo de conexión" },
  "Por favor, preencha o número do Slot de Teste.": { es: "Por favor, rellene el número de la ranura de prueba." },
  "Biblioteca": { es: "Biblioteca" },
  "Upload Direto do Computador:": { es: "Subida directa desde la computadora:" },
  "Ou URL Direta da Mídia (HTTPS):": { es: "O URL directa del archivo (HTTPS):" },
  "Áudio será entregue como nota de voz oficial do WhatsApp gravada na hora (com microfone verde e waveform).": { es: "El audio se entregará como nota de voz oficial de WhatsApp grabada al instante (con micrófono verde y forma de onda)." },
  "Áudio (PTT)": { es: "Audio (PTT)" },
  "Erro no upload do arquivo": { es: "Error en la subida del archivo" },
  "0:28 • Vídeo MP4": { es: "0:28 • Video MP4" },
  "Vídeo MP4": { es: "Video MP4" },
  "Slot de Teste do Agendador": { es: "Ranura de prueba del programador" },
  "Dispare a etapa selecionada para o número de teste e comprove o fluxo no WhatsApp antes de agendar.": { es: "Dispare el paso seleccionado al número de prueba y compruebe el flujo en WhatsApp antes de programar." },
  "Testar Fluxo Agora": { es: "Probar flujo ahora" },
  "Fluxo testado com sucesso via WAHA!": { es: "¡Flujo probado con éxito vía WAHA!" },
  "Selecione a etapa para pré-visualização e teste:": { es: "Seleccione el paso para previsualización y prueba:" },
  "Prévia Ativa": { es: "Vista previa activa" },
  "Anexar Mídia:": { es: "Adjuntar archivo:" },
  "Pausar Áudio": { es: "Pausar audio" },
  "Ouvir Áudio": { es: "Escuchar audio" },
};
